...
<p class="pct25"><?php echo $control->caption; ?></p>
<p class="pct75">
<?php
...
endforeach;
?>
<a href="#" onclick="return controls.textmulti.add(this, '<?php echo $field; ?>');" class="textmulti_add" title="<?php _e( 'add' ); ?>">[<?php _e( 'add' ); ?>]</a>
<?php
